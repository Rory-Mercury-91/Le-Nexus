...
function mapMovieForDb(movie, {
  ...
  return {
    ...
    note_moyenne: movie.vote_average != null ? Math.round(movie.vote_average * 10) / 10 : null,
    nb_votes: movie.vote_count || null,
    popularite: movie.popularity != null ? (typeof movie.popularity === 'string' ? parseFloat(movie.popularity.replace(',', '.')) || null : movie.popularity) : null,
