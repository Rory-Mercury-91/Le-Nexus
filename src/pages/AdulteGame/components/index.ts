...
export { default as AdulteGameParamsCard } from './AdulteGameParamsCard';
export { default as AdulteGameTagsCard } from './AdulteGameTagsCard';
export { default as AdulteGameTraductionCard } from './AdulteGameTraductionCard';
