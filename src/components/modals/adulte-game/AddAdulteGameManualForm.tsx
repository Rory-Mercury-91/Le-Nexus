        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '16px', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <label htmlFor="statut_jeu" className="label" style={{ marginBottom: '8px', minHeight: '22px' }}>
                Statut du jeu
              </label>
              <select
                id="statut_jeu"
            ...
            {/* Version */}
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <label htmlFor="version" className="label" style={{ marginBottom: '8px', minHeight: '22px' }}>
            ...
            {/* Moteur */}
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <label htmlFor="moteur" className="label" style={{ marginBottom: '8px', minHeight: '22px' }}>
